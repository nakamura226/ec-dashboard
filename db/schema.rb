...
ActiveRecord::Schema[8.1].define(version: 2026_09_25_010713) do
  create_table "sales_records", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["order_number"], name: "index_sales_records_on_order_number"
    t.index ["store_id"], name: "index_sales_records_on_store_id"
  end
  ...
  create_table "sync_logs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id"], name: "index_sync_logs_on_store_id"
  end

  add_foreign_key "sales_records", "stores"
  ...
  add_foreign_key "sync_logs", "stores"
end
